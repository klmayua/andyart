  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 pt-24">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-andy-stone/30 rounded-2xl p-6 space-y-6">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-andy-stone/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-andy-gold/30 bg-andy-ivory/50"
          ...
          <button
            ...
            className="w-full bg-white border border-andy-stone/30 py-3 rounded-full font-medium text-andy-black hover:bg-andy-ivory transition-colors flex items-center justify-center gap-2 text-sm"
          >
