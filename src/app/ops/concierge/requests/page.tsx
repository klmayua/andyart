  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-serif text-2xl font-bold text-andy-black">Requests</h1>
          <p className="text-sm text-andy-bronze mt-1">{filtered.length} of {requests.length} requests</p>
        </div>
      </div>

      <div className="bg-white rounded-2xl border border-andy-stone/20 p-4 mb-6 flex flex-wrap gap-3">
      ...
      <div className="space-y-3">
        {filtered.map((req) => (
          <div key={req.id} className="bg-white rounded-2xl border border-andy-stone/20 p-5 hover:border-andy-gold/30 transition-all">
